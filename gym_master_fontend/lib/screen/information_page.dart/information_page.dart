...
var _weightController = TextEditingController();
  ...
  void signUp() async {
    ...
    var response = await http.post(
        Uri.parse('http://192.168.2.221:8080/user/register'),
    ...
    try {
      ...
      if (response.statusCode == 201) {
        ...
        'http://192.168.2.221:8080/user/selectFromEmail/${widget.email.toString()}',
      );
      var userModel = userModelFromJson(jsonEncode(response.data));
    if (response.statusCode == 200) {
  try {
    final progressRes = await dio.post(
      'http://192.168.2.221:8080/progress/weightInsert',
      data: {
