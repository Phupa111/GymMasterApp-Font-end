...
class CuttingTabPage extends StatelessWidget {
  const CuttingTabPage({super.key, required this.tdeeData});
          ...
          child: Column(
            children: [
              ...
              const Padding(
                padding: EdgeInsets.only(bottom: 10.0),
                child: Text(
                  "*Cutting คือการลดน้ำหนักหรือลดไขมัน",
                  style: TextStyle(
                      color: Color(0xffFFAC41),
                      fontFamily: 'Kanit',
                      fontSize: 16.0),
