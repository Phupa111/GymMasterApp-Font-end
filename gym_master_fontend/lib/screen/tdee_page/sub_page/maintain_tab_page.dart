...
class MaintainTabPage extends StatelessWidget {
  const MaintainTabPage({super.key, required this.tdeeData});
          ...
          child: Column(
            children: [
              ...
              const Padding(
                padding: EdgeInsets.only(bottom: 10.0),
                child: Text(
                  "*Maintain คือการรักษาน้ำหนักหรือคงหุ่นไว้กับที่",
                  style: TextStyle(
                      color: Color(0xffFFAC41),
                      fontFamily: 'Kanit',
                      fontSize: 16.0),
