...
void checkEmailUsername() async {
  ...
  try {
   var emailResponse = await dio.get(
      'http://192.168.2.182:8080/user/selectFromEmail/${_emailController.text.toString()}',
    );

var  userResponse = await dio.get(
      'http://192.168.2.182:8080/user/selectFromEmail/${_usernameController.text.toString()}',
    );
  ...
  try {
    ...
    if (user != null) {
      final response = await dio.get(
        'http://192.168.2.182:8080/user/selectFromEmail/${user.email.toString()}',
      );
