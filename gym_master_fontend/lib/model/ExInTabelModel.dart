...
List<ExInTabelModel> exInTabelModelFromJson(String str) => List<ExInTabelModel>.from(json.decode(str).map((x) => ExInTabelModel.fromJson(x)));

String exInTabelModelToJson(List<ExInTabelModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
